...
public static class TaskSerializationTests
{
    ...
    public static void CreateTaskResult_SerializationRoundTrip_PreservesAllProperties()
    {
        ...
        string json = JsonSerializer.Serialize(original, McpTasksJsonUtilities.DefaultOptions);
        var deserialized = JsonSerializer.Deserialize<CreateTaskResult>(json, McpTasksJsonUtilities.DefaultOptions);
    ...
    public static void CreateTaskResult_UsesCorrectWireFieldNames()
    {
        ...
        string json = JsonSerializer.Serialize(result, McpTasksJsonUtilities.DefaultOptions);
    ...
    public static void GetTaskResult_Working_RoundTrip()
    {
        ...
        string json = JsonSerializer.Serialize<GetTaskResult>(original, McpTasksJsonUtilities.DefaultOptions);
        var deserialized = JsonSerializer.Deserialize<GetTaskResult>(json, McpTasksJsonUtilities.DefaultOptions);
    ...
    public static void GetTaskResult_Converter_DispatchesToCorrectSubtypeByStatus()
    {
        ...
        foreach (var (status, expectedType) in statuses)
        {
            ...
            var result = JsonSerializer.Deserialize<GetTaskResult>(json, McpTasksJsonUtilities.DefaultOptions);
    ...
    public static void GetTaskResult_MissingTaskId_ThrowsJsonException()
    {
        ...
        Assert.Throws<JsonException>(() => JsonSerializer.Deserialize<GetTaskResult>(json, McpTasksJsonUtilities.DefaultOptions));
    }
    ...
    public static void GetTaskResult_WireResultType_IsComplete_WhenSet(Type subType)
    {
        ...
        GetTaskResult value = subType switch
        {
            ...
            Type t when t == typeof(InputRequiredTaskResult) => new InputRequiredTaskResult
            {
                ...
                InputRequests = new Dictionary<string, InputRequest>
                {
                    ...
                    {
                        Method = "test/method",
                        Params = JsonSerializer.SerializeToElement("ask", McpTasksJsonUtilities.DefaultOptions),
                    },
                },
            },
        ...
        string json = JsonSerializer.Serialize(value, McpTasksJsonUtilities.DefaultOptions);
        var node = JsonNode.Parse(json)!;
    ...
    {
        string json = JsonSerializer.Serialize(status, McpTasksJsonUtilities.DefaultOptions);
        Assert.Equal($"\"{expectedWireValue}\"", json);

        var deserialized = JsonSerializer.Deserialize<McpTaskStatus>(json, McpTasksJsonUtilities.DefaultOptions);
    ...
    public static void TaskStatusNotificationParams_Working_RoundTrip()
    {
        ...
        string json = JsonSerializer.Serialize<TaskStatusNotificationParams>(original, McpTasksJsonUtilities.DefaultOptions);
        var deserialized = JsonSerializer.Deserialize<TaskStatusNotificationParams>(json, McpTasksJsonUtilities.DefaultOptions);
