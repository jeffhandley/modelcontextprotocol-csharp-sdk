    ...
    internal sealed class Converter : JsonConverter<GetTaskResult>
    {
            ...
            while (reader.Read())
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "resultType":
                        ...
                        break;
                    case "_meta":
                        meta = JsonSerializer.Deserialize(ref reader, TasksJsonContext.Default.JsonObject);
                        break;
                    case "result":
                    ...
                    case "inputRequests":
                        ...
                        while (reader.Read())
                        {
                            ...
                            reader.Read();
                            var inputRequest = JsonSerializer.Deserialize(ref reader, TasksJsonContext.Default.InputRequest)
        ...
        public override void Write(Utf8JsonWriter writer, GetTaskResult value, JsonSerializerOptions options)
        {
            ...
            if (value.Meta is not null)
            {
                ...
                JsonSerializer.Serialize(writer, value.Meta, TasksJsonContext.Default.JsonObject);
            }
                ...
                case InputRequiredTaskResult inputRequired:
                    ...
                    if (inputRequired.InputRequests is { } reqs)
                    {
                        foreach (var kvp in reqs)
                        {
                            ...
                            JsonSerializer.Serialize(writer, kvp.Value, TasksJsonContext.Default.InputRequest);
                        }
                    }
